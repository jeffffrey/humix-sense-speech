...
$(OBJ_SPHINXBASE):
	...
	cd deps/sphinxbase-$(SPHINXBASE_VER); export CFLAGS=" -march=atom -O2 -Wall -fPIC -m32"; ./configure --enable-fixed
...
$(OBJ_POCKETSPHINX): $(OBJ_SPHINXBASE)
	...
	cd deps/pocketsphinx-$(POCKETSPHINX_VER); export CFLAGS=" -march=atom -O2 -Wall -fPIC -m32"; ./configure
